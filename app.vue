<template>
  <!-- landing -->
  <div class="snap-both snap-mandatory">
    <div class="w-full hero-glam">
      <div class="xl:container xl:mx-auto py-8 px-12 xl:px-0 flex flex-col">
        <Navigation />
    ...
    <div class="w-full bg-gray-100">
      <div class="xl:container xl:mx-auto py-8 px-12 xl:px-0 flex flex-col">
        ...
        <div class="flex flex-row items-center my-52 gap-x-48">
          <div
            class="bg-gray-100 rounded-full shadow-neumorphic-circle p-10 flex justify-center items-center"
          >
            <!--<div
              class="border-red-500 border-[42px] rounded-full h-80 w-80"
            ></div>-->
            <canvas ref="chartTarget" class="h-96 w-96"></canvas>
          </div>
          <div>
            <h2 class="text-efont font-Inter text-4xl font-medium">
              Allocation
            </h2>
            <article></article>
          </div>
